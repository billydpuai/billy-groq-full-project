...
print("Step 1: Scraping DePaul financial aid page...")
...
print("Step 2: Loading Billy (Llama 3.1 8B)...")
model_path = "models/Llama-3.1-8B-Instruct"
tokenizer = AutoTokenizer.from_pretrained(model_path)
model = AutoModelForCausalLM.from_pretrained(model_path, torch_dtype=torch.bfloat16, device_map="auto")
print("Billy is ready!")

question = "Based on the information provided, what should a student do first to get financial aid, and where can they check their application status?"
